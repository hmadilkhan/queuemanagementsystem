...
<div class="w-100 p-3 p-md-5 card border-0 bg-dark text-light" style="max-width: 32rem;">
    ...
    <form class="row g-1 p-3 p-md-4" wire:submit="login">
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <a class="underline text-sm dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800 text-white" href="{{ route('password.request') }}" wire:navigate>
