            ...
            <form wire:submit.prevent="save">
                <div class="row g-3  mb-3 align-items-center">
                    <div class="col-sm-3">
                        ...
                        <select class="form-select form-control select2 form-control-md"
                            aria-label="Default select Country" id="countryId" wire:model="countryId">
                    ...
                    <div class="col-sm-3">
                        ...
                        <select class="form-select select2 form-control form-control-md"
                            aria-label="Default select city" id="cityId" wire:model="cityId"
                            {{ is_null($countryId) ? 'disabled' : '' }}>
                    ...
                    <div class="col-sm-3 ">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                            wire:model="name" placeholder="Enter Complete Name">
                        @error('name')
                    ...
                    <div class="col-sm-3 ">
                        ...
                        <input type="text" class="form-control @error('email') is-invalid @enderror" id="email"
                            wire:model="email" placeholder="Enter Complete Email">
                        @error('email')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col-sm-3 ">
                        ...
                        <input type="text" class="form-control @error('mobile') is-invalid @enderror" id="mobile"
                            wire:model="mobile" placeholder="Enter Complete Mobile">
                        @error('mobile')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col-sm-3 ">
                        ...
                        <input type="text" class="form-control @error('ptcl') is-invalid @enderror"
                             wire:model="ptcl" placeholder="Enter Complete Landline">
                        @error('ptcl')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col-sm-3 ">
                        ...
                        <input type="text" class="form-control @error('address') is-invalid @enderror" id="address"
                            wire:model="address" placeholder="Enter Complete Address">
                        @error('address')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    @if ($image )
                        <div class="form-group">
                            ...
                            <img src="{{ ($mode == 0 ? $image->temporaryUrl() : asset('storage/'.$image)) }}" alt="Image Preview" class="img-thumbnail"
